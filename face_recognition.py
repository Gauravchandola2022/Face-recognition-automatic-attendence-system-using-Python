...
# 1st image
        img_top=Image.open(r"images_collage\face-recognition-freepik1170x658.jpg")
        img_top=img_top.resize((650,700),Image.Resampling.LANCZOS)
        self.photoimg_top=ImageTk.PhotoImage(img_top)

        l_lbl=Label(self.root,image=self.photoimg_top)
        l_lbl.place(x=0,y=55,width=650,height=700)
# 2nd image
        img_bottom=Image.open(r"images_collage\facial_recognition_system_identification_digital_id_security_scanning_thinkstock_858236252_3x3-100740902-large.webp")
        img_bottom=img_bottom.resize((900,700),Image.Resampling.LANCZOS)
...
# button
        ...
        b1_1.place(x=350,y=615,width=200,height=40)
        # ***************attendence***************************
    def mark_attendence(self,i,r,n,d):    
        with open("Gaurav.csv","r+",newline="\n") as f:
